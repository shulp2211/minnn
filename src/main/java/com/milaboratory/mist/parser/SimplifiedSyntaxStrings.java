...
final class SimplifiedSyntaxStrings {
    ...
    /* object names that are valid as outer objects for group edge positions; this array doesn't include
       NOT_OPERATOR_NAME, GROUP_EDGE_NAME and GROUP_EDGE_POSITION_NAME */
    final static List<String> validGroupOuterObjectNames = Arrays.asList(FUZZY_MATCH_PATTERN_NAME, AND_PATTERN_NAME,
            PLUS_PATTERN_NAME, OR_PATTERN_NAME, MULTI_PATTERN_NAME, AND_OPERATOR_NAME, OR_OPERATOR_NAME,
    ...
    final static List<String> validGroupPartNotCommonObjectNames = Arrays.asList(FUZZY_MATCH_PATTERN_NAME,
            PLUS_PATTERN_NAME, FILTER_PATTERN_NAME, BORDER_FILTER_NAME, SCORE_FILTER_NAME);
